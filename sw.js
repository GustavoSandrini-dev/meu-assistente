const C = "ma-v5";
const SHELL = ["./","./index.html","./painel-financeiro-web.html","./biblioteca-jogos-web.html","./filmes-web.html","./livros-web.html","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
