const C = "ma-v7";
const SHELL = ["./","./index.html","./painel-financeiro-web.html","./biblioteca-jogos-web.html","./filmes-web.html","./livros-web.html","./common.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
