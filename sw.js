const C = "ma-v38";
const SHELL = ["./","./index.html","./painel-financeiro-web.html","./biblioteca-jogos-web.html","./filmes-web.html","./livros-web.html","./tarefas-web.html","./common.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
